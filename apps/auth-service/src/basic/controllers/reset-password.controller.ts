import { IBasicAuthResetPasswordRpcController } from '@app/contracts/interfaces/controller/auth-controller.interface';
...
@Controller()
export class ResetPasswordController implements IBasicAuthResetPasswordRpcController {
  constructor(
