...
/** Category colors for the interview prep PDF **/
const CATEGORY_COLORS: Record<
  string,
  { bg: string; text: string; border: string }
> = {
  Technical: { bg: '#eff6ff', text: '#1d4ed8', border: '#bfdbfe' },
  Behavioral: { bg: '#f5f3ff', text: '#555456', border: '#ddd6fe' },
...
/** Category chip for the interview prep PDF **/
...
/** Question block for the interview prep PDF **/
