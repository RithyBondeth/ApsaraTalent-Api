...
export class UpdateEmployeeInfoController implements IUpdateEmployeeController {
    ...
    async updateEmployeeInfo(@Payload() payload: { updateEmployeeInfoDTO: UpdateEmployeeInfoDTO, employeeId: string }) {
        return this.updateEmployeeInfoService.updateEmployeeInfo(payload.updateEmployeeInfoDTO, payload.employeeId);
    }
}